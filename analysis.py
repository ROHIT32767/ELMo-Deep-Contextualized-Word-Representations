...
elmomodel = torch.load('model.pt',weights_only=False,map_location=torch.device(device))

# List of saved model paths
saved_models = [
    'classification_model_method1.pt',
    'classification_model_method2.pt',
    'classification_model_method3.pt'
]
...
for model_path in saved_models:
    ...
    # Print metrics
    print('Train Accuracy: {:.4f}, F1 Score: {:.4f}, Precision: {:.4f}, Recall: {:.4f}'.format(
    ...
    print('Test Accuracy: {:.4f}, F1 Score: {:.4f}, Precision: {:.4f}, Recall: {:.4f}'.format(
    ...
    # Print lambda values (if applicable)
    if hasattr(model, 'lamda1'):
        print("Lambda values:")
        print(f"lamda1: {model.lamda1.item():.4f}, lamda2: {model.lamda2.item():.4f}, lamda3: {model.lamda3.item():.4f}")
    else:
        print("Lambda values not applicable for this model.")
